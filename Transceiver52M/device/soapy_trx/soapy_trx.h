...
#ifndef _SOAPY_DEVICE_H_
#define _SOAPY_DEVICE_H_
...
public:
	...
	/** Object constructor */
	soapy_device(size_t tx_sps, size_t rx_sps, InterfaceType iface, size_t chan_num, double lo_offset,
